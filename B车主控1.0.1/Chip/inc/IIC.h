...
/*************************************************************/
/*********定义时钟线*********/ 
#define SCL1out  gpio_init(PTB0, GPO, 0)//DDRC19=1          //陀螺仪
#define SCL1_L_   PTB0_OUT=0
#define SCL1_H_   PTB0_OUT=1
/*********定义数据线*********/
#define SDA1out  gpio_init(PTB1, GPO, 0)//DDRD0=1
#define SDA1_L_   PTB1_OUT=0
#define SDA1_H_   PTB1_OUT=1
#define SDA1in   gpio_init(PTB1, GPI, 0)//DDRA15=0
#define SDA1_read PTB1_IN



//#define SCLout  gpio_init(PTA14, GPO, 0)//DDRC19=1
//#define SCL_L_   PTA14_OUT=0
//#define SCL_H_   PTA14_OUT=1
///*********定义数据线*********/
//#define SDAout  gpio_init(PTA15, GPO, 0)//DDRD0=1
//#define SDA_L_   PTA15_OUT=0
//#define SDA_H_   PTA15_OUT=1
//#define SDAin   gpio_init(PTA15, GPI, 0)//DDRA15=0
//#define SDA_read PTA15_IN
/*************************************************************/
/******************************IIC 端口宏定义*****************/
/*************************************************************/
...
/*********定义时钟线*********/
#define SCLout  gpio_init(PTC10, GPO, 0)//DDRC19=1          //加速度G
#define SCL_L_   PTC10_OUT=0
#define SCL_H_   PTC10_OUT=1
/*********定义数据线*********/
#define SDAout  gpio_init(PTC11, GPO, 0)//DDRD0=1
#define SDA_L_   PTC11_OUT=0
#define SDA_H_   PTC11_OUT=1
#define SDAin   gpio_init(PTC11, GPI, 0)//DDRA15=0
#define SDA_read PTC11_IN

/*************************************************************/
/*****************MMA8451 register definition start************/
/*************************************************************/

#define nop5() {asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");}
#define nops() {asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");  {\
...
/*************************************************************/
/*****************MMA8451 register definition end************/
/*************************************************************/



/*************************************************************/
/**********L3G4200D register definition start*****************/
/*************************************************************/
//**********L3G4200D内部寄存器地址*********
...
//****************************************
#define	L3G_Address   0x69	  //定义器件在IIC总线中的从地址,根据ALT  ADDRESS地址引脚不同修改
/*************************************************************/
/*****************L3G4200D register definition end************/
/*************************************************************/
...
long int Get_Gyro(unsigned char n,unsigned char Axis) ;
/*************************************************************/
/*****************函数声明************/
/*************************************************************/
