...
//陀螺仪参数
#define MPU6050_GYRO_FS_250                     0x00            //131   LSB/(°/s)
#define MPU6050_GYRO_FS_500                     0x01            //65.5  LSB/(°/s)
#define MPU6050_GYRO_FS_1000                    0x02            //32.8  LSB/(°/s)
#define MPU6050_GYRO_FS_2000                    0x03            //16.4  LSB/(°/s)
//加速度计参数
#define MPU6050_ACCEL_FS_2                      0x00            //16384 LSB/g
#define MPU6050_ACCEL_FS_4                      0x01            //8192  LSB/g
#define MPU6050_ACCEL_FS_8                      0x02            //4096  LSB/g
#define MPU6050_ACCEL_FS_16                     0x03            //2048  LSB/g
//数字低通滤波器频率
