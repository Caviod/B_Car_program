...
#define ADC_GET_PL adc_once(ADC1_SE15,ADC_16bit)//1 11
#define ADC_GET_PM adc_once(ADC0_SE10,ADC_16bit)//0 13
#define ADC_GET_PR adc_once(ADC0_SE14,ADC_16bit)//0 8
#define ADC_GET_VL adc_once(ADC1_SE14,ADC_16bit)//1 10
#define ADC_GET_VR adc_once(ADC0_SE9,ADC_16bit)//0 12
